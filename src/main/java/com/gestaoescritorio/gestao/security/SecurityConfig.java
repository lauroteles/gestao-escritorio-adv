...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // 🔥 Ativa CORS ANTES
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(Arrays.asList("Authorization")); // 🔥 Expor header de resposta
